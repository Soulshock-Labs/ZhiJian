    ...
    return textwrap.dedent(f"""
        ...
        {{
          ...
          "activities": {{
            ...
            "environment": "环创活动方案 2-3 条（每条≤30字），逗号或换行分隔。【禁止】自己加 1. 2. 等编号，只写内容，系统会编号",
            "life":        "生活活动目标 2-3 条（每条≤20字），用「能」字句，如：能整理玩具、能独立洗手。【禁止】自己加 1. 2. 编号，只写内容",
            ...
            "family":      "家园共育建议 2-3 条（每条≤25字），逗号或换行分隔。【禁止】自己加 1. 2. 编号，只写内容",
        ...
        ✓ outdoor/game/study：5 种不同活动名称，用逗号/换行/顿号分隔即可
        ✓ life/family/environment：2-3 条建议，逗号或换行分隔即可
        ✗ **禁止**自己加 "1." "2." "一、" "①" 等任何编号或日期前缀（周一/周二），系统会统一加
        ✓ 你只需保证：内容质量、数量正确、字数不超限
